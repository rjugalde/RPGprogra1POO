 ...
 * @author estep
 */
public class ElixirdeBrujeria extends javax.swing.JFrame {

    /**
     * Creates new form ElixirdeBrujeria
     */
    public ElixirdeBrujeria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel39.setText("Elixir de Brujeria");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElixirdeBrujeria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ElixirdeBrujeria().setVisible(true);
            }
        });
    }
