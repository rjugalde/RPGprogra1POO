 ...
 * @author estep
 */
public class CuchillaOscura extends javax.swing.JFrame {

    /**
     * Creates new form CuchillaOscura
     */
    public CuchillaOscura() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel39.setText("Cuchilla Oscura");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CuchillaOscura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CuchillaOscura().setVisible(true);
            }
        });
    }
